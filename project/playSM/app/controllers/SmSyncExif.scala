...
/**
  ...
  */
@Singleton
class SmSyncExif @Inject()(cc: MessagesControllerComponents, config: Configuration, val database: DBService, ws: WSClient)
  extends MessagesAbstractController(cc) {

  val logger: Logger = play.api.Logger(getClass)

  val smSyncDeviceStream = new SmSyncDeviceStream(cc, config, database, ws)
