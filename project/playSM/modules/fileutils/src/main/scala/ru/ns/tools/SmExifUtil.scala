...
object SmExifUtil {
  ...
  def extractDateTimeKeyMp4FromExifMap(hTags: Map[String, String], key: String): Option[java.time.LocalDateTime] = {
    ...
    val dow: scala.collection.Map[java.lang.Long, String] = Map(long2Long(1L) -> "Mon", long2Long(2L) -> "Tue", long2Long(3L) -> "Wed", long2Long(4L) -> "Thu", long2Long(5L) -> "Fri", long2Long(6L) -> "Sat", long2Long(7L) -> "Sun")
    // custom map for months
    val moy: scala.collection.Map[java.lang.Long, String] = Map(long2Long(1L) -> "Jan", long2Long(2L) -> "Feb", long2Long(3L) -> "Mar", long2Long(4L) -> "Apr", long2Long(5L) -> "May", long2Long(6L) -> "Jun", long2Long(7L) -> "Jul", long2Long(8L) -> "Aug", long2Long(9L) -> "Sep", long2Long(10L) -> "Oct", long2Long(11L) -> "Nov", long2Long(12L) -> "Dec")
